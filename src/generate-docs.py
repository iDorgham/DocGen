#!/usr/bin/env python3
"""
Script to generate documentation using DocGen templates.

This script demonstrates how to use the DocGen templates to generate
marketing, project plan, and technical specification documents.
"""
...
def main():
    ...
    print("DocGen Document Generation Demo")
    print("=" * 40)
    
    # Load project data
    data_file = 'sample_project_data.yaml'
